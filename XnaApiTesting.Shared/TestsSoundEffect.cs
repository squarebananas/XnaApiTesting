...
public class TestsSoundEffect
{
    ...
    public TestsSoundEffect(ContentManager contentManager)
    {
        ...
        AddSound(contentManager, "rock_loop_mono.wav", 44100, 16, AudioChannels.Mono);
        AddSound(contentManager, "rock_loop_stereo.wav", 44100, 16, AudioChannels.Stereo);
        AddSound(contentManager, "rock_loop_stereo_44hz_8bit.wav", 44100, 8, AudioChannels.Stereo);
        AddSound(contentManager, "rock_loop_stereo_22hz.wav", 22050, 16, AudioChannels.Stereo);
        AddSound(contentManager, "bark_mono_44hz_16bit.wav", 44100, 16, AudioChannels.Mono);
        AddSound(contentManager, "bark_mono_44hz_32bit.wav", 44100, 32, AudioChannels.Mono);
        AddSound(contentManager, "tone_mono_44khz_16bit.xnb", 44100, 16, AudioChannels.Mono);
        AddSound(contentManager, "tone_stereo_44khz_24bit.wav", 44100, 24, AudioChannels.Stereo);
        AddSound(contentManager, "tone_stereo_44khz_msadpcm.xnb", 44100, null, AudioChannels.Stereo);
        AddSound(contentManager, "tone_stereo_44khz_float.wav", 44100, null, AudioChannels.Stereo);
        AddSound(contentManager, "split_tones.wav", 44100, 16, AudioChannels.Stereo);
        AddSound(contentManager, "left_tone.wav", 44100, 16, AudioChannels.Stereo);
        AddSound(contentManager, "right_tone.wav", 44100, 16, AudioChannels.Stereo);
    ...
    public void AddSound(ContentManager contentManager, string name, int? sampleRate = null, int? sampleBits = null, AudioChannels? audioChannels = null)
    {
        SoundData soundEffectData = new(contentManager, name, SoundData.SoundType.SoundEffect);
        _soundsList.Items.Add(soundEffectData.ListBoxItem);

        SoundData soundEffectInstanceData = new(contentManager, name, SoundData.SoundType.SoundEffectInstance);
        ...
        {
            SoundData dynamicSoundEffectInstanceData = new(contentManager, name, SoundData.SoundType.DynamicSoundEffectInstance, sampleRate, audioChannels);
