...
{
    return xTexture3D.Sample(TextureSampler, float3((input.Position3D.x + 1) / 2, (input.Position3D.y + 1) / 2, (input.Position3D.z + 1) / 2)) * xColor;
}
